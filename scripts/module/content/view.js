            ...
            <div class="fika-reader-mode" id="fika-reader" style="display: none;">
                <div id="fika" class="fika-app theme-vanilla">
                    ...
                    C21,8,22,8.5,22.8,9.3c0.9-0.2,1.7-0.5,2.5-1c-0.3,0.9-1,1.7-1.8,2.2c0.8,0,1.5-0.2,2.3-0.6C25.2,10.8,24.6,11.4,23.9,11.9z"/>
                                ...
                                <a id="fika-facebook-share" href="https://www.facebook.com/sharer/sharer.php?title=Read a lot of articles? This extension brings a Kindle-like reading experience to your browser&u=https://chrome.google.com/webstore/detail/fika-reader-mode/fbcdnjeoghampomjjaahjgjghdjdbbcj" target="_blank">
                                    <svg class="fika-icon fika-icon-large" viewBox="0 0 32 32">
