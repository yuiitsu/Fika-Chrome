...
App.module.extend('background', function() {
    ...
    this.fetchData = async function (data, send_response) {
        ...
        photos.slice(0,5).forEach(function(i){
            $('<img/>')[0].src = i.full;
        });
        store = await self.getStore();
